...
const styles = StyleSheet.create({
  ...
  labelCoin: { color: colors.primary },
  ...
  fillCardHero: { backgroundColor: 'rgba(255,255,255,0.4)' },
  fillCashHero: { backgroundColor: 'rgba(255,255,255,0.55)' },
  fillCardDetail: { backgroundColor: '#D8D8DC' },
  fillCashDetail: { backgroundColor: '#B8B8BE' },
  ...
  amountCoin: { color: colors.primary },
  ...
  bestBadgeDetail: { backgroundColor: colors.primary, marginTop: 8 },
  bestText: { fontSize: 10, fontWeight: '700', letterSpacing: 0.4 },
  bestTextHero: { color: colors.primary },
