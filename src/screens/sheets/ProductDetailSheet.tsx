...
const styles = StyleSheet.create({
  ...
  resaleTagText: { fontSize: 9, fontFamily: fonts.sansBold, color: colors.primary, letterSpacing: 0.4 },
  ...
  reasonChipText: { fontSize: 11.5, color: colors.primary, fontFamily: fonts.sansBold },
