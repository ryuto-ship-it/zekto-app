...
const styles = StyleSheet.create({
  ...
  iconZekto: { backgroundColor: colors.jadeTint },
  iconZektoText: { color: colors.jadeDeep, fontWeight: '700', fontSize: 16 },
  ...
  spinner: {
    width: 52, height: 52, borderRadius: 26, borderWidth: 4, borderColor: colors.jadeTint,
    borderTopColor: colors.jadeDeep, marginBottom: 18,
  },
  ...
  checkCircle: {
    width: 60, height: 60, borderRadius: 30, backgroundColor: colors.jadeTint,
    alignItems: 'center', justifyContent: 'center', marginBottom: 16,
  },
  checkMark: { fontSize: 26, color: colors.jadeDeep },
